...
class RegisterEmailOrMobileDesign extends StatelessWidget {
  final String title;
  final String subTitle;
  final String buttonNextText;
  final String buttonToggleText;
  final Widget registerCardBody;
  final Function()? onTapNext;
  final Function()? onTapToggle;
  const RegisterEmailOrMobileDesign({super.key,
    required this.title, required this.subTitle, required this.buttonNextText,required this.buttonToggleText,
    required this.registerCardBody, required this.onTapNext, required this.onTapToggle
  });
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: Container(
                          height: 1.h,
                          color: MainColors.blueGrey,
                          margin: EdgeInsets.symmetric(horizontal: 12.w),
                        ),
                      ),
                      Text(
                        'OR',
                        style: MainTextStyles.font18black300weight, // or your preferred style
                      ),
                      Expanded(
                        child: Container(
                          height: 1.h,
